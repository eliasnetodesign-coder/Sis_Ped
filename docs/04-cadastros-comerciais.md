# 04 — Cadastros Comerciais

Módulo `admin/cadastros/*`. Acesso: `comercial`, `supervisor` ou `tecnologia da informacao` (salvo onde indicado). Cada cadastro está documentado em seu próprio arquivo, na pasta [`cadastros/`](cadastros/).

## Índice dos cadastros

| Cadastro | Arquivo | Documento |
|----------|---------|-----------|
| **Clientes** | `clientes.php` | [cadastros/clientes.md](cadastros/clientes.md) |
| **Grupo de Empresas** | `grupo-empresas.php` | [cadastros/grupo-empresas.md](cadastros/grupo-empresas.md) |
| **Produtos** (+ KIT) | `produtos.php` | [cadastros/produtos.md](cadastros/produtos.md) |
| **Tabela de Preços** | `tabela-precos.php` | [cadastros/tabela-precos.md](cadastros/tabela-precos.md) |
| **Canal de Venda** | `canal-venda.php` | [cadastros/canal-venda.md](cadastros/canal-venda.md) |
| **Campanhas** | `campanhas.php` | [05-campanhas.md](05-campanhas.md) |
| **NCM** | `ncm.php` | [cadastros/ncm.md](cadastros/ncm.md) |
| **Metas** | `metas.php` | [cadastros/metas.md](cadastros/metas.md) |
